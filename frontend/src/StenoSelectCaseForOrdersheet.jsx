                    ...
                    <div className="main-content">
                        ...
                        <div className="filters-top">
                            ...
                            >
                                ...
                                <option value="malik">Hon. Justice Malik Ashraf</option>
                                <option value="shah">Hon. Justice Shah Ahmed</option>
                                <option value="khan">Hon. Justice Khan Sahib</option>
                            </select>
                            <select
                                className="form-select"
                                ...
                                {filteredCases.map((c) => (
                                    <tr key={c.id}>
                                        ...
                                        <button
                                            ...
                                            onClick={() =>
                                                navigate("/stenographer-dashboard/select-case-ordersheet/ordersheet-generation", { state: { selectedCase: c } })
                                            }
