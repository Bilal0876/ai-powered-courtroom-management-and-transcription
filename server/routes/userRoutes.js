...
router.post("/update", authenticateToken, requireRole(['admin']), userController.updateUser);
router.post("/delete", authenticateToken, requireRole(['admin']), userController.deleteUser);
